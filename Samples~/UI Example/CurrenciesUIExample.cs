...
public class CurrenciesUIExample : MonoBehaviour
{
    ...
    GetBalancesResult m_LatestGetBalancesResult = new GetBalancesResult(new List<PlayerBalance>(), false);
    bool m_HasNext;
    ...
    public async void FetchBalances()
    {
        ...
        else
        {
            ...
            {
                CurrencyDefinition currency = await Economy.Configuration.GetCurrencyAsync(balance.CurrencyId);
                if (currency != null)
                {
