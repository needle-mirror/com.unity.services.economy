...
namespace Unity.Services.Economy.Model
{
    ...
    public class Store
    {
        [Preserve]
        [JsonConstructor]
        public Store(string code, string message, string receipt)
        {
            Code = code;
            Message = message;
            Receipt = receipt;
        ...
        /// <summary>
        /// The full response from the verification service as a JSON encoded string.
        /// </summary>
        [Preserve] 
    ...
    {
        [Preserve]
        public Verification(StatusOptions status, Store store)
        {
            Status = status;
            Store = store;
        }
