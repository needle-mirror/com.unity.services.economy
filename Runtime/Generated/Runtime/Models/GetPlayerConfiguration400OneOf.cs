...
{
    /// <summary>
    /// GetPlayerConfiguration400OneOf model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(GetPlayerConfiguration400OneOfJsonConverter))]
    [DataContract(Name = "GetPlayerConfiguration400OneOf")]
    internal class GetPlayerConfiguration400OneOf : IOneOf
    {
        ...
        /// <summary>GetPlayerConfiguration400OneOf Constructor</summary>
        /// <param name="value">The value as an object for GetPlayerConfiguration400OneOf</param>
        /// <param name="type">The type for GetPlayerConfiguration400OneOf</param>
        public GetPlayerConfiguration400OneOf(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        /// <summary>
        /// Converts the JSON string into an instance of GetPlayerConfiguration400OneOf
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of GetPlayerConfiguration400OneOf</returns>
        public static GetPlayerConfiguration400OneOf FromJson(string jsonString)
        {
            if (jsonString == null)
            {
                return null;
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("GetPlayerConfiguration400OneOf", DiscriminatorKey);
                }
        ...
        private static GetPlayerConfiguration400OneOf DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new GetPlayerConfiguration400OneOf(actualObject, concreteType);
        }

        private static GetPlayerConfiguration400OneOf DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new GetPlayerConfiguration400OneOf(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for GetPlayerConfiguration400OneOf to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class GetPlayerConfiguration400OneOfJsonConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return GetPlayerConfiguration400OneOf.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
