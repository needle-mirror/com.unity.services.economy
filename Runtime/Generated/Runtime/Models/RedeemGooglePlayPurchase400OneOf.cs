...
{
    /// <summary>
    /// RedeemGooglePlayPurchase400OneOf model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(RedeemGooglePlayPurchase400OneOfJsonConverter))]
    [DataContract(Name = "RedeemGooglePlayPurchase400OneOf")]
    internal class RedeemGooglePlayPurchase400OneOf : IOneOf
    {
        ...
        /// <summary>RedeemGooglePlayPurchase400OneOf Constructor</summary>
        /// <param name="value">The value as an object for RedeemGooglePlayPurchase400OneOf</param>
        /// <param name="type">The type for RedeemGooglePlayPurchase400OneOf</param>
        public RedeemGooglePlayPurchase400OneOf(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        /// <summary>
        /// Converts the JSON string into an instance of RedeemGooglePlayPurchase400OneOf
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of RedeemGooglePlayPurchase400OneOf</returns>
        public static RedeemGooglePlayPurchase400OneOf FromJson(string jsonString)
        {
            if (jsonString == null)
            {
                return null;
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("RedeemGooglePlayPurchase400OneOf", DiscriminatorKey);
                }
        ...
        private static RedeemGooglePlayPurchase400OneOf DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new RedeemGooglePlayPurchase400OneOf(actualObject, concreteType);
        }

        private static RedeemGooglePlayPurchase400OneOf DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new RedeemGooglePlayPurchase400OneOf(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for RedeemGooglePlayPurchase400OneOf to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class RedeemGooglePlayPurchase400OneOfJsonConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return RedeemGooglePlayPurchase400OneOf.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
