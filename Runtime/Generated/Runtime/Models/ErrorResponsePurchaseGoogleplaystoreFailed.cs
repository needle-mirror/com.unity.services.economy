...
namespace Unity.Services.Economy.Internal.Models
{
    ...
    internal class ErrorResponsePurchaseGoogleplaystoreFailed
    {
        ...
        [Preserve]
        public ErrorResponsePurchaseGoogleplaystoreFailed(string type, string title, int status, int code, string detail, PlayerPurchaseGoogleplaystoreResponse data, string instance = default)
        {
            Type = type;
            Title = title;
            Status = status;
