...
namespace Unity.Services.Economy.Internal.Models
{
    ...
    internal class PlayerPurchaseVirtualResponseRewards
    {
        ...
        [Preserve]
        public PlayerPurchaseVirtualResponseRewards(List<InventoryExchangeItem> inventory, List<CurrencyExchangeItem> currency = default)
        {
            Currency = currency;
            Inventory = inventory;
        }
        ...
        /// <summary>
        /// Formats a PlayerPurchaseVirtualResponseRewards into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a PlayerPurchaseVirtualResponseRewards as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
