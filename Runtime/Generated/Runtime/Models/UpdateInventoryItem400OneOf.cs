...
{
    /// <summary>
    /// UpdateInventoryItem400OneOf model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(UpdateInventoryItem400OneOfJsonConverter))]
    [DataContract(Name = "UpdateInventoryItem400OneOf")]
    internal class UpdateInventoryItem400OneOf : IOneOf
    {
        ...
        /// <summary>UpdateInventoryItem400OneOf Constructor</summary>
        /// <param name="value">The value as an object for UpdateInventoryItem400OneOf</param>
        /// <param name="type">The type for UpdateInventoryItem400OneOf</param>
        public UpdateInventoryItem400OneOf(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        /// <summary>
        /// Converts the JSON string into an instance of UpdateInventoryItem400OneOf
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of UpdateInventoryItem400OneOf</returns>
        public static UpdateInventoryItem400OneOf FromJson(string jsonString)
        {
            if (jsonString == null)
            {
                return null;
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("UpdateInventoryItem400OneOf", DiscriminatorKey);
                }
        ...
        private static UpdateInventoryItem400OneOf DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new UpdateInventoryItem400OneOf(actualObject, concreteType);
        }

        private static UpdateInventoryItem400OneOf DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new UpdateInventoryItem400OneOf(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for UpdateInventoryItem400OneOf to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class UpdateInventoryItem400OneOfJsonConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return UpdateInventoryItem400OneOf.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
