...
namespace Unity.Services.Economy.Editor.Authoring.AdminApi.Client.Models
{
    ...
    internal class GetResourcesResponse
    {
        ...
        [Preserve]
        public GetResourcesResponse(List<GetResourcesResponseResultsInner> results, int offset, int limit, int total)
        {
            Results = results;
            Offset = offset;
            Limit = limit;
        ...
        /// <summary>
        /// Formats a GetResourcesResponse into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a GetResourcesResponse as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
