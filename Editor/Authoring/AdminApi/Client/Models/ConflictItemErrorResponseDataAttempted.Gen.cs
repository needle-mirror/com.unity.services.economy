...
{
    /// <summary>
    /// ConflictItemErrorResponseDataAttempted model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(ConflictItemErrorResponseDataAttemptedJsonConverter))]
    [DataContract(Name = "ConflictItemErrorResponseDataAttempted")]
    internal class ConflictItemErrorResponseDataAttempted : IOneOf
    {
        ...
        /// <summary>ConflictItemErrorResponseDataAttempted Constructor</summary>
        /// <param name="value">The value as an object for ConflictItemErrorResponseDataAttempted</param>
        /// <param name="type">The type for ConflictItemErrorResponseDataAttempted</param>
        public ConflictItemErrorResponseDataAttempted(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        public static ConflictItemErrorResponseDataAttempted FromJson(string jsonString)
        {
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("ConflictItemErrorResponseDataAttempted", DiscriminatorKey);
                }
        ...
        private static ConflictItemErrorResponseDataAttempted DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new ConflictItemErrorResponseDataAttempted(actualObject, concreteType);
        }

        private static ConflictItemErrorResponseDataAttempted DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new ConflictItemErrorResponseDataAttempted(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for ConflictItemErrorResponseDataAttempted to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class ConflictItemErrorResponseDataAttemptedJsonConverter : JsonConverter
    {
        ...
        {
            return objectType == typeof(ConflictItemErrorResponseDataAttempted);
        }
    }
}
