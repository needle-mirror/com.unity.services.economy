...
{
    /// <summary>
    /// AddConfigResource201Response model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(AddConfigResource201ResponseJsonConverter))]
    [DataContract(Name = "AddConfigResource201Response")]
    internal class AddConfigResource201Response : IOneOf
    {
        ...
        /// <summary>AddConfigResource201Response Constructor</summary>
        /// <param name="value">The value as an object for AddConfigResource201Response</param>
        /// <param name="type">The type for AddConfigResource201Response</param>
        public AddConfigResource201Response(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        public static AddConfigResource201Response FromJson(string jsonString)
        {
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("AddConfigResource201Response", DiscriminatorKey);
                }
        ...
        private static AddConfigResource201Response DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new AddConfigResource201Response(actualObject, concreteType);
        }

        private static AddConfigResource201Response DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new AddConfigResource201Response(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for AddConfigResource201Response to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class AddConfigResource201ResponseJsonConverter : JsonConverter
    {
        ...
        {
            return objectType == typeof(AddConfigResource201Response);
        }
    }
}
