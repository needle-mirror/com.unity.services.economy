...
using Unity.Services.Economy.Editor.Authoring.AdminApi.Client.Scheduler;
...
namespace Unity.Services.Economy.Client.EconomyAdmin
{
    ...
    /// <summary>
    /// EconomyAdminApiBaseRequest class
    /// </summary>
    [Preserve]
    internal class EconomyAdminApiBaseRequest
    {
        /// <summary>
    ...
    /// </summary>
    [Preserve]
    internal class AddConfigResourceRequest : EconomyAdminApiBaseRequest
    {
        ...
        /// <summary>Accessor for addConfigResourceRequestParameter </summary>
        [Preserve]
        public Unity.Services.Economy.Editor.Authoring.AdminApi.Client.Models.AddConfigResourceRequest AddConfigResourceRequestParameter { get; }
        string PathAndQueryParams;

        /// <summary>
        /// AddConfigResource Request Object.
        /// Add Config Resource
        /// </summary>
        /// <param name="projectId">ID of the project.</param>
        /// <param name="environmentId">ID of the environment</param>
        /// <param name="addConfigResourceRequestParameter">Add config resource, currency, inventory item.</param>
        [Preserve]
        public AddConfigResourceRequest(string projectId, System.Guid environmentId, Unity.Services.Economy.Editor.Authoring.AdminApi.Client.Models.AddConfigResourceRequest addConfigResourceRequestParameter)
        {
            ProjectId = projectId;

            EnvironmentId = environmentId;

            AddConfigResourceRequestParameter = addConfigResourceRequestParameter;
            PathAndQueryParams = $"/economy/v2/projects/{projectId}/environments/{environmentId}/configs/draft/resources";
        ...
        {
            return ConstructBody(AddConfigResourceRequestParameter.Value);
        }
            ...
            Configuration operationConfiguration = null)
        {
            ...
            headers.Add("Unity-Client-Mode", EngineStateHelper.IsPlaying ? "play" : "edit");
    ...
    /// <summary>
    /// DeleteConfigResourceRequest
    /// Delete Config Resource
    /// </summary>
    [Preserve]
    internal class DeleteConfigResourceRequest : EconomyAdminApiBaseRequest
    {
        /// <summary>Accessor for projectId </summary>
        [Preserve]
        public string ProjectId { get; }
        ...
        /// <summary>
        /// DeleteConfigResource Request Object.
        /// Delete Config Resource
        /// </summary>
        /// <param name="projectId">ID of the project.</param>
        /// <param name="environmentId">ID of the environment</param>
        ...
        [Preserve]
        public DeleteConfigResourceRequest(string projectId, System.Guid environmentId, string resourceId)
        {
            ProjectId = projectId;
            ...
            PathAndQueryParams = $"/economy/v2/projects/{projectId}/environments/{environmentId}/configs/draft/resources/{resourceId}";
    ...
    /// <summary>
    /// EditConfigResourceRequest
    /// Edit Config Resource
    /// </summary>
    [Preserve]
    internal class EditConfigResourceRequest : EconomyAdminApiBaseRequest
    {
        /// <summary>Accessor for projectId </summary>
        [Preserve]
        public string ProjectId { get; }
        ...
        [Preserve]
        public string ResourceId { get; }
        /// <summary>Accessor for addConfigResourceRequest </summary>
        [Preserve]
        public Unity.Services.Economy.Editor.Authoring.AdminApi.Client.Models.AddConfigResourceRequest AddConfigResourceRequest { get; }
        string PathAndQueryParams;

        /// <summary>
        /// EditConfigResource Request Object.
        /// Edit Config Resource
        /// </summary>
        /// <param name="projectId">ID of the project.</param>
        /// <param name="environmentId">ID of the environment</param>
        ...
        [Preserve]
        public EditConfigResourceRequest(string projectId, System.Guid environmentId, string resourceId, Unity.Services.Economy.Editor.Authoring.AdminApi.Client.Models.AddConfigResourceRequest addConfigResourceRequest)
        {
            ProjectId = projectId;
            ...
            AddConfigResourceRequest = addConfigResourceRequest;
            PathAndQueryParams = $"/economy/v2/projects/{projectId}/environments/{environmentId}/configs/draft/resources/{resourceId}";
        ...
        public byte[] ConstructBody()
        {
            return ConstructBody(AddConfigResourceRequest.Value);
        }
    ...
    /// <summary>
    /// GetPublishedResourcesRequest
    /// Get Published Resources
    /// </summary>
    [Preserve]
    internal class GetPublishedResourcesRequest : EconomyAdminApiBaseRequest
    {
        /// <summary>Accessor for projectId </summary>
        [Preserve]
        public string ProjectId { get; }
        ...
        /// <summary>
        /// GetPublishedResources Request Object.
        /// Get Published Resources
        /// </summary>
        /// <param name="projectId">ID of the project.</param>
        /// <param name="environmentId">ID of the environment</param>
        /// <param name="offset">Defaults to 0</param>
        /// <param name="limit">Number of items to be returned. Defaults to 1000</param>
        [Preserve]
        public GetPublishedResourcesRequest(string projectId, System.Guid environmentId, int? offset = default(int?), int? limit = default(int?))
        {
            ProjectId = projectId;
            ...
            Offset = offset;
            Limit = limit;
            PathAndQueryParams = $"/economy/v2/projects/{projectId}/environments/{environmentId}/configs/published/resources";
    ...
    /// </summary>
    [Preserve]
    internal class GetResourcesRequest : EconomyAdminApiBaseRequest
    {
        /// <summary>Accessor for projectId </summary>
        [Preserve]
        public string ProjectId { get; }
        ...
        /// <param name="limit">Number of items to be returned. Defaults to 1000</param>
        [Preserve]
        public GetResourcesRequest(string projectId, System.Guid environmentId, int? offset = default(int?), int? limit = default(int?))
        {
            ProjectId = projectId;
    ...
    /// <summary>
    /// PublishEconomyRequest
    /// Publish Economy
    /// </summary>
    [Preserve]
    internal class PublishEconomyRequest : EconomyAdminApiBaseRequest
    {
        /// <summary>Accessor for projectId </summary>
        [Preserve]
        public string ProjectId { get; }
        ...
        [Preserve]
        public System.Guid EnvironmentId { get; }
        /// <summary>Accessor for publishBody </summary>
        [Preserve]
        public Unity.Services.Economy.Editor.Authoring.AdminApi.Client.Models.PublishBody PublishBody { get; }
        string PathAndQueryParams;

        /// <summary>
        /// PublishEconomy Request Object.
        /// Publish Economy
        /// </summary>
        /// <param name="projectId">ID of the project.</param>
        /// <param name="environmentId">ID of the environment</param>
        /// <param name="publishBody">PublishBody param</param>
        [Preserve]
        public PublishEconomyRequest(string projectId, System.Guid environmentId, Unity.Services.Economy.Editor.Authoring.AdminApi.Client.Models.PublishBody publishBody)
        {
            ProjectId = projectId;
            ...
            PathAndQueryParams = $"/economy/v2/projects/{projectId}/environments/{environmentId}/configs/draft";
        ...
        public byte[] ConstructBody()
        {
            return ConstructBody(PublishBody);
        }
