...
namespace Unity.Services.Economy.Editor.Authoring.Shared.Logging
{
    static class Logger
    {
        const string k_Tag = "[Economy]";

        const string k_VerboseLoggingDefine = "ENABLE_UNITY_ECONOMY_VERBOSE_LOGGING";
